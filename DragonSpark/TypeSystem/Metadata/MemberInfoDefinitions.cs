...
{
	sealed class MemberInfoDefinitions : ParameterizedSourceBase<MemberInfo>
	{
		public static IParameterizedSource<object, MemberInfo> Default { get; } = new MemberInfoDefinitions().ToSingletonScope();
		MemberInfoDefinitions() : this( TypeDefinitions.Default.Get ) {}
		...
		public MemberInfoDefinitions( Func<object, TypeInfo> typeSource )
		{
