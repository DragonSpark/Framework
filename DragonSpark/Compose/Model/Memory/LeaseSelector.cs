...
namespace DragonSpark.Compose.Model.Memory
{
	...
	{
		readonly DragonSpark.Model.Sequences.Memory.Lease<T> _subject;

		public LeaseSelector(DragonSpark.Model.Sequences.Memory.Lease<T> subject) => _subject = subject;
		...
		public DragonSpark.Model.Sequences.Memory.Lease<TTo> OfType<TTo>() => OfType<T, TTo>.Default.Get(_subject);
	}
}