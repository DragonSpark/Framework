...
public class ReferenceValueTable<TIn, TOut> : ITable<TIn, TOut> where TIn : class where TOut : class? // TODO: Audit use for alternative Concurrent (or standard) Tables
{
