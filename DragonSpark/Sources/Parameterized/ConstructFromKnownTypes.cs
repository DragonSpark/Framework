...
namespace DragonSpark.Sources.Parameterized
{
	...
	{
		public static ISource<IParameterizedSource<object, T>> Default { get; } = new ScopedSingleton<IParameterizedSource<object, T>>( () => new ConstructFromKnownTypes<T>( KnownTypes.Default.Get<T>().ToArray() ) );
