...
namespace DragonSpark.Modularity
{
	...
	public class ModuleInfoGroup : IModuleCatalogItem, IList<ModuleInfo>, IList // IList must be supported in Silverlight 2 to be able to add items from XAML
	{
		...
		protected virtual void ForwardValues([Required]ModuleInfo moduleInfo)
		{}
		...
		/// </returns>
		bool IList.Contains([Required]object value)
		{
		...
		/// </exception>
		public void Insert(int index, [Required]object value)
		{
			ModuleInfo moduleInfo = value as ModuleInfo;
		...
		/// </returns>
		public bool IsSynchronized => ((ICollection)this.modules).IsSynchronized;
		...
		/// </returns>
		public object SyncRoot => ((ICollection)this.modules).SyncRoot;
