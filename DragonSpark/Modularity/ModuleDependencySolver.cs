...
namespace DragonSpark.Modularity
{
	...
	{
		readonly ListDictionary<string, string> dependencyMatrix = new ListDictionary<string, string>();
		readonly List<string> knownModules = new List<string>();
		...
		/// depends on.</param>
		public void AddDependency([NotEmpty]string dependingModule, [NotEmpty]string dependentModule)
		{
