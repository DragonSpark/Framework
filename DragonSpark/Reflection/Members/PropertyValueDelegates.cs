...
namespace DragonSpark.Reflection.Members
{
	...
	{
		public static PropertyValueDelegates Default { get; } = new PropertyValueDelegates();
	...
	public sealed class PropertyValueDelegates<T> : ReferenceValueStore<PropertyInfo, Func<object, T>>, IPropertyValueDelegate<T>
	{
		public static PropertyValueDelegates<T> Default { get; } = new PropertyValueDelegates<T>();
