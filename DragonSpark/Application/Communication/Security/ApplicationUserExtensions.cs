...
{
	public class SecurityDataObjectContextFactory : Factory<string, SecurityData>
	{
		protected override SecurityData CreateItem( string source )
		{
			...
			var result = new SecurityData( connectionString );
			return result;
		}
