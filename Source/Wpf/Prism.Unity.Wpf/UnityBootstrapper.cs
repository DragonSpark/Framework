    ...
    public abstract class UnityBootstrapper : Bootstrapper
    {
        ...
        protected virtual void ConfigureContainer()
        {
            ...
            if (useDefaultConfiguration)
            {
				...
				RegisterTypeIfMissing(typeof(IAssemblyResolver), typeof(AssemblyResolver), true);
				RegisterTypeIfMissing(typeof(IModuleTypeLoader), typeof(FileModuleTypeLoader), true);
