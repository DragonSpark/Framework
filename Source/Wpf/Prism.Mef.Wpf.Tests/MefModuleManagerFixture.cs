...
namespace Prism.Mef.Wpf.Tests
{
    ...
    public partial class MefModuleManagerFixture
    {
        ...
        public void DownloadCompletedRaisedForImportedModulesInCatalog()
        {
            ...
            var moduleManager = new TestableMefModuleManager(mockModuleInitializer.Object, mockModuleCatalog.Object, mockLogger.Object, new Mock<IModuleTypeLoader>().Object)
                                    {
                                        Modules =
        ...
        internal class TestableMefModuleManager : MefModuleManager
        {
            public TestableMefModuleManager()
                : this(new Mock<IModuleInitializer>().Object, new Mock<IModuleCatalog>().Object, new Mock<ILoggerFacade>().Object, new Mock<IModuleTypeLoader>().Object)
            {
            }

            public TestableMefModuleManager(IModuleInitializer moduleInitializer, IModuleCatalog moduleCatalog, ILoggerFacade loggerFacade, IModuleTypeLoader typeLoader)
                : base(moduleInitializer, moduleCatalog, loggerFacade, typeLoader)
            {
            }
