...
namespace Prism.Mef.Wpf.Tests
{
    ...
    public class MefFileModuleTypeLoaderFixture
    {
        ...
        {
            MefFileModuleTypeLoader loader = new MefFileModuleTypeLoader();
            var info = this.CreateModuleInfo();
        ...
        public DynamicModuleInfo CreateModuleInfo()
        {
	        var info = new DynamicModuleInfo
	        {
		        ModuleName = "MefModuleOne",
		        Ref = "file:///MefModulesForTesting.dll"
	        };
