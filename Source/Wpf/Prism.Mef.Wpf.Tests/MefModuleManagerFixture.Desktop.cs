...
namespace Prism.Mef.Wpf.Tests
{
    public partial class MefModuleManagerFixture
    {
        ...
        public void ConstructorThrowsWithNullModuleInitializer()
        {
            try
            {
                new MefModuleManager(null, new Mock<IModuleCatalog>().Object, new Mock<ILoggerFacade>().Object, new Mock<IModuleTypeLoader>().Object);
        ...
        public void ConstructorThrowsWithNullModuleCatalog()
        {
            try
            {
                new MefModuleManager(new Mock<IModuleInitializer>().Object, null, new Mock<ILoggerFacade>().Object, new Mock<IModuleTypeLoader>().Object);
                Assert.Fail("No exception thrown when expected");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void ConstructorThrowsWithNullLogger()
        {
            try
            {
                new MefModuleManager(new Mock<IModuleInitializer>().Object, new Mock<IModuleCatalog>().Object, null, new Mock<IModuleTypeLoader>().Object );
                Assert.Fail("No exception thrown when expected");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void ModuleInUnreferencedAssemblyInitializedByModuleInitializer()
        {
            ...
            MefModuleManager moduleManager = new MefModuleManager(
                ...
                moduleCatalog,
                mockLoggerFacade.Object, new Mock<IModuleTypeLoader>().Object);
        ...
        public void DeclaredModuleWithoutTypeInUnreferencedAssemblyIsUpdatedWithTypeNameFromExportAttribute()
        {
            ...
            ModuleCatalog moduleCatalog = new ModuleCatalog();
            ModuleInfo moduleInfo = new DynamicModuleInfo { ModuleName = "MefModuleOne" };
