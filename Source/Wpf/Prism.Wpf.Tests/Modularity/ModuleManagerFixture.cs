...
namespace Prism.Wpf.Tests.Modularity
{
    ...
    public class ModuleManagerFixture
    {
        ...
        {
            new ModuleManager(null, new MockModuleCatalog(), new MockLogger(), new MockModuleTypeLoader());
        }
        ...
        {
            new ModuleManager(new MockModuleInitializer(), null, new MockLogger(), new MockModuleTypeLoader());
        }
        ...
        {
            new ModuleManager(new MockModuleInitializer(), new MockModuleCatalog(), null, new MockModuleTypeLoader());
        }       
        ...
        public void ShouldInitializeModuleOnDemand()
        {
	        ...
	        ModuleManager manager = new ModuleManager( loader, catalog, new MockLogger(), moduleRetriever ) { ModuleTypeLoaders = new List<IModuleTypeLoader> { moduleRetriever } };
	        manager.Run();
        ...
        public void ShouldLogMessageOnModuleRetrievalError()
        {
            ...
            ModuleManager manager = new ModuleManager(loader, catalog, logger, new MockModuleTypeLoader());
            var moduleTypeLoader = new MockModuleTypeLoader();
        ...
        {
            var moduleInfo = new DynamicModuleInfo(type.Name, type.AssemblyQualifiedName);
            moduleInfo.InitializationMode = initializationMode;
            moduleInfo.DependsOn.AddRange(dependsOn);
            return moduleInfo;
        }
