...
namespace DragonSpark.Application.Mobile.Model;

/// ATTRIBUTION: https://github.com/jamesmontemagno/dotnet-maui-observablerangecollection/blob/master/RangeCollectionDemo/ObservableRangeCollection.cs
/// <summary> 
...
public class ObservableRangeCollection<T> : ObservableCollection<T>
{
                         ...
                         NotifyCollectionChangedAction notificationMode = NotifyCollectionChangedAction.Add)
    {
        ...
        var added = AddArrangeCore(items);
        if (added)
        {
