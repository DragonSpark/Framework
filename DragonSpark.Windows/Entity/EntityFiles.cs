...
namespace DragonSpark.Windows.Entity
{
	public static class EntityFiles
	{
		...
		public static FileInfo GetLog( FileInfo database ) => new FileInfo( Path.Combine( database.DirectoryName, string.Concat( Path.GetFileNameWithoutExtension( database.Name ), "_log.ldf" ) ) );
	}
}