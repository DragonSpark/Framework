...
namespace DragonSpark.Windows.FileSystem
{
	...
	{
		public static IParameterizedScope<string, IFileInfo> Default { get; } = new ParameterizedScopedSingleton<string, IFileInfo>( o => new FileInfoFactory().ToEqualityCache().Get );
		FileInfoFactory() : base( DefaultImplementation.Implementation.Get ) {}

		public sealed class DefaultImplementation : ParameterizedScopedSingleton<string, FileInfoBase>
		{
