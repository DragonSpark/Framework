...
namespace DragonSpark.Windows.Modularity
{
	...
	public class ModuleConfigurationElementCollection : ConfigurationElementCollection
	{
		...
		public ModuleConfigurationElementCollection([Required]ModuleConfigurationElement[] modules)
		{
			modules.Each( BaseAdd );
		}
		...
		public ModuleConfigurationElement this[int index] => (ModuleConfigurationElement)base.BaseGet(index);
