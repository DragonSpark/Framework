...
public static class Extensions
{
	                                              ...
	                                              IPolicySelector selector)
	{
		...
		@this.TryAddSingleton<ApplicationTokenValidation>();

		return @this.ConfigureOptions<BearerConfiguration>()
		            .AddAuthentication(x => x.DefaultScheme = x.DefaultChallengeScheme = name)
