...
{
	public EntityMigrator(DbContext source, DbContext destination) : this(source, destination, DefaultMap.Default) {}

	public EntityMigrator(DbContext source, DbContext destination, string name)
		: this(new(source, destination, name), DefaultMap.Default) {}
