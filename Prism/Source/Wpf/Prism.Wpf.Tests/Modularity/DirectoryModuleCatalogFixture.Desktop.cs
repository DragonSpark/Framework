...
namespace Prism.Wpf.Tests.Modularity
{
    ...
    public class DirectoryModuleCatalogFixture
    {
        ...
        {
            DirectoryModuleCatalog catalog = new DirectoryModuleCatalog { ModulePath = null };
            catalog.Load();
        }
        ...
        {
            DirectoryModuleCatalog catalog = new DirectoryModuleCatalog { ModulePath =  string.Empty };
            catalog.Load();
        }
        ...
        public void ShouldReturnAListOfModuleInfo()
        {
            ...
            var modules = catalog.Modules.OfType<DynamicModuleInfo>().ToArray();
        ...
        public void ShouldNotLoadAssembliesInCurrentAppDomain()
        {
            ...
            Assembly loadedAssembly = AppDomain.CurrentDomain.GetAssemblies()
                ...
                .FirstOrDefault(assembly => assembly.Location.Equals(modules[0].Ref, StringComparison.InvariantCultureIgnoreCase));
