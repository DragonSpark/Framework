...
namespace Prism.Wpf.Tests
{
    public class CompilerHelper 
    {
        ...
        public static CompilerResults CompileFile(string input, string output, params string[] references)
        {
			...
			referencedAssemblies.Add("System.Runtime.dll");
            ...
            referencedAssemblies.Add(typeof(DynamicModuleAttribute).Assembly.CodeBase.Replace(@"file:///", ""));
        ...
        public static CompilerResults CompileCode(string code, string output)
        {
	        ...
	        var referencedAssemblies = new List<string>
	        {
		        "System.dll",
				"System.Runtime.dll",
				typeof(IModule).Assembly.CodeBase.Replace( @"file:///", "" ),
				typeof(ModuleAttribute).Assembly.CodeBase.Replace( @"file:///", "" ),
				typeof(DynamicModuleAttribute).Assembly.CodeBase.Replace( @"file:///", "" )
	        };
