    ...
    public partial class LongListSelector : Control
    {
        ...
        private class LongListSelectorItemsControl : ItemsControl
        {
            ...
            protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
            {
                ...
                ((UIElement)element).MouseLeftButtonUp += LongListSelectorItemsControl_Tap;
            }
            ...
            private void LongListSelectorItemsControl_Tap(object sender, System.Windows.Input.MouseEventArgs e)
            {
