...
{
    public class LocateOnSetupExtension : LocateExtension
    {
        public LocateOnSetupExtension()
        {}

        public LocateOnSetupExtension( Type type ) : base( type )
        {}

        public LocateOnSetupExtension( Type type, string buildName ) : base( type, buildName )
        {}
