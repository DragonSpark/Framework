...
namespace DragonSpark.Server.Legacy.Io
{
	public partial class Workspace : IWorkspace
	{
		...
		public Workspace( string directory )
		{
			...
			Log.Information( string.Format( Resources.Message_Workspace_Created, this.directory.Name ) );
		}
		...
		protected virtual void Dispose( bool disposing )
		{
			Log.Try( () =>
			{
				...
				Log.Information( string.Format( Resources.Message_Workspace_Dispose, directory ) );
