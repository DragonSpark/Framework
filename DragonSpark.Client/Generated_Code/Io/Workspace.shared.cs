...
namespace DragonSpark.Io
{
	public partial class Workspace : IWorkspace
	{
		...
		public Workspace( string directory )
		{
			...
			Logging.Information( string.Format( Resources.Message_Workspace_Created, this.directory.Name ) );
		}
		...
		protected virtual void Dispose( bool disposing )
		{
			Logging.Try( () =>
			{
				...
				Logging.Information( string.Format( Resources.Message_Workspace_Dispose, directory ) );
