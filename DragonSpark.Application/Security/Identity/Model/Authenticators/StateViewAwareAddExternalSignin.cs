...
{
	sealed class StateViewAwareAddExternalSignin : IAddExternalSignin
	{
		readonly IAddExternalSignin        _previous;
		readonly IClearAuthenticationState _clear;

		public StateViewAwareAddExternalSignin(IAddExternalSignin previous, IClearAuthenticationState clear)
		{
			_previous = previous;
			_clear    = clear;
		}
