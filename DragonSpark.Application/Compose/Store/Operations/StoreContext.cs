...
{
	readonly DragonSpark.Compose.Model.Operations.OperationResultComposer<TIn, TOut> _subject;

	public StoreContext(DragonSpark.Compose.Model.Operations.OperationResultComposer<TIn, TOut> subject)
		=> _subject = subject;
