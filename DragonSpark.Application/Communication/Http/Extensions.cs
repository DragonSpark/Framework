...
public static class Extensions
{
	...
	public static IServiceCollection AddRefitApi<T>(this IServiceCollection @this, Options options)
		where T : class => AddRefitApi<T>(@this, options, x => x);

	public static IServiceCollection AddRefitApi<T>(this IServiceCollection @this, Options options,
	                                                Func<IHttpClientBuilder, IHttpClientBuilder> builder)
		where T : class
		=> @this.AddRefitApi<T>(options, (_, _) => {}, (x, _) => builder(x));

	public static IServiceCollection AddRefitApi<T>(this IServiceCollection @this,
	                                                Func<IHttpClientBuilder, IHttpClientBuilder> builder)
		where T : class => AddRefitApi<T>(@this, DefaultName<T>.Default, builder);

	public static IServiceCollection AddRefitApi<T>(this IServiceCollection @this, string name)
		where T : class => AddRefitApi<T>(@this, name, x => x);
	...
	public static IServiceCollection AddRefitApi<T, TOptions>(this IServiceCollection @this)
		...
		=> @this.AddRefitApi<T, TOptions>(DefaultName<T>.Default);
	...
	// ReSharper disable once TooManyArguments
	public static IServiceCollection AddRefitApi<T, TOptions>(
		this IServiceCollection @this, string name, TOptions options,
		Action<IServiceProvider, RefitSettings> settings,
		Func<IHttpClientBuilder, TOptions, IHttpClientBuilder> configure)
		where TOptions : Options where T : class
		=> AddRefitClient<T, TOptions>.Default.Get(new(@this, name, options, settings, configure));
}